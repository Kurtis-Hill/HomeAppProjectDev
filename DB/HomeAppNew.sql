...
--
-- Host: localhost
-- Generation Time: Dec 29, 2020 at 01:32 AM
...
CREATE TABLE `analog` (
  ...
  `highAnalog` smallint(6) DEFAULT NULL,
  `lowAnalog` smallint(6) DEFAULT NULL,
...
INSERT INTO `analog` (`analogID`, `sensorNameID`, `analogReading`, `highAnalog`, `lowAnalog`, `constRecord`, `deviceNameID`, `timez`) VALUES
(3, 9, 2444, 5000, 10000, 1, 76, '2020-12-23 14:17:55');
...
INSERT INTO `dallas` (`dallasID`, `tempID`, `cardViewID`) VALUES
(1, 9, 8),
(2, 10, 12);
...
INSERT INTO `devicenames` (`deviceNameID`, `deviceName`, `deviceSecret`, `groupNameID`, `roomID`, `createdBy`) VALUES
(74, 'LivingRoomTankSensor', '532454564554', 1, 1, 1),
(75, 'Baby', '34542523453', 1, 2, 1),
(76, 'OfficeAir', '234233234234', 2, 3, 1),
(77, 'bmptest', '324234', 1, 3, 1);
...
CREATE TABLE `humid` (
  `humidID` int(11) NOT NULL,
  `sensorNameID` int(11) DEFAULT NULL,
  `humidReading` int(11) NOT NULL,
  `highHumid` int(11) NOT NULL DEFAULT 70,
  `lowHumid` int(11) NOT NULL DEFAULT 15,
...
INSERT INTO `humid` (`humidID`, `sensorNameID`, `humidReading`, `highHumid`, `lowHumid`, `constRecord`, `deviceNameID`, `timez`) VALUES
(3, 6, 55, 70, 15, 0, 74, '2020-12-23 14:13:38'),
(4, 7, 55, 70, 15, 0, 76, '2020-12-23 14:38:13'),
(5, 8, 76, 50, 60, 1, 75, '2020-12-23 14:38:13'),
(6, 10, 55, 70, 15, 0, 77, '2020-12-23 14:53:13');
...
(7, 10, 77, 9870, 789, 789, 0, '2020-12-17 00:00:00');
...
(527, '82de61d548ccde0cfa0c0eab182ba74cc91c9eaa0cec728db97cedf42f36e7a50645aa65bfb49478e0c7d0f8da4946e3f5cbf3ad5875e88b64d4bce4bb10783f', 'admin', '2020-12-23 22:35:31'),
(528, 'e8ab84cf87f27092492e7c54ba93dac284cfea14faec9135642fb7e04774ac6b8b9047bedaf0881be2514a03527848d2cebb0ceaddba5c4f1f9776b1b5afadca', 'admin', '2020-12-24 15:33:49'),
(529, '3988a24c4ecf43653828cf95f7a818bbb2bc5587bb5c1bf488232e7fe75b0c6b56bda4953fa30a1cd263bc6deaab7d0196fe23aa75afb9cccbd729e5f60ef304', 'admin', '2020-12-24 15:47:31'),
(530, 'e2cb8ae61a763450d10101877536650aac5843b0f68ca145743fa8e0396ae5c28d1e158d6753bed0b512436d2e725f1f0266d6d047f865c4106a579e7fb3d30d', 'admin', '2020-12-24 15:49:34'),
(531, '02ed610a288c4455aa8703224eb6d1c78bfe51616080d9126d9f7acd2dedc955f92aeccea2827b0994600e37d477b0ce667669adc5f323c58b83341dc60d53e8', 'admin', '2020-12-24 16:31:28'),
(532, '3ef185a3d5d2258c21abfa79a530ef330cf7e9bbfaf24bdf67353ea5bd9dbe0895a9bfd3267c70e7107504147c848312a5601aeb9614c25374225aad2f8ebaa3', 'admin', '2020-12-24 16:39:56'),
(533, '8f8e1aa5308c77e0edeab19a437296f5b24e43fafa5afa400277c7557328836be0743507c8f67c30c7e5ad16365ca9063fb4faa0a58b57a01603fab5fe5fd20c', 'admin', '2020-12-24 16:40:12'),
(534, 'd881795617bb5231883673fea70264a9ddd9a3ebaed05e6ad7b32fae421ebe837e70c3b6151ddccf5ac9c1bf122cf8e5b184cd7dc329377dbe34bd664b5b0242', 'admin', '2020-12-26 15:56:54'),
(535, 'fa6385adb36766b1ed11b1831e68f3517659f9353e3be87b4d6db75df408e855e027e7732c9650c5f66ff26cbfa48216eb35ec50b01dfa73aad7e7844c94f436', 'admin', '2020-12-26 15:58:43'),
(536, '8b2dddc2b85bdbb4642ed6111781fdc6ced143b2603fb0977f39fa2bdfb9045eed5d54be362bc05d584a50c5ccebd33f92e5fa2f3a05357045b6dbcbe71b70fe', 'admin', '2020-12-27 01:38:23'),
(537, 'd2c41d82f1d4cc2f7b2f28f731c95637a754b293f3419e8659354094dd83e7557df3041b47150c2174c989925a03d5dce1e49d95dcf5b6f974f1e1382d12206e', 'admin', '2020-12-28 00:49:48'),
(538, 'e8d2edd8e80b1a371d20026e7ff06f6b4424d6718d08b3c96f69380004440c58409dbfded3c7261476cf6d0d9021e99b7189242198decf65d0ca05d27b92d807', 'admin', '2020-12-28 15:41:07'),
(539, '313d59c93de3270d9895998e45c50d6bc2d4fa27457f077b9fcadde68b2f326739aad1d943867dee4d4de6a4da745cfdf42d24d5e2f38ac9af8a93d9918116c5', 'admin', '2020-12-28 19:11:37');
...
(4, 'FishTank', 74, 2),
(5, 'Turtle Tank', 74, 2),
(6, 'living room air', 74, 1),
(7, 'Office breath air', 76, 1),
(8, 'Baby air', 75, 1),
(9, 'plants', 76, 3),
(10, 'bmpSensor', 77, 4);
...
INSERT INTO `temp` (`tempID`, `sensorNameID`, `tempReading`, `highTemp`, `lowTemp`, `constRecord`, `deviceNameID`, `timez`) VALUES
(9, 4, 10, 12, 10, 0, 74, '2020-12-23 14:12:20'),
(10, 5, 22, 26, 12, 0, 74, '2020-12-23 14:12:20'),
(11, 6, 23, 26, 12, 0, 74, '2020-12-23 14:13:08'),
(12, 8, 3, 50, 6, 1, 75, '2020-12-23 14:16:52'),
(13, 7, 22, 26, 12, 0, 76, '2020-12-23 14:16:52'),
(14, 10, 10, 26, 12, 0, 77, '2020-12-23 14:52:52');
...
ALTER TABLE `devicenames`
  ...
  ADD UNIQUE KEY `deviceSecret` (`deviceSecret`),
...
--
ALTER TABLE `analog`
  MODIFY `analogID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `cardview`
  MODIFY `cardViewID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `dallas`
  MODIFY `dallasID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `devicenames`
--
ALTER TABLE `devicenames`
  MODIFY `deviceNameID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `dhtsensor`
--
ALTER TABLE `dhtsensor`
  MODIFY `dhtID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `humid`
  MODIFY `humidID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `latitude`
  MODIFY `latitudeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `sensornames`
  MODIFY `sensorNameID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `soil`
  MODIFY `soilID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
