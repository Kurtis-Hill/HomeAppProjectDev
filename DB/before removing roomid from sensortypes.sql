...
--
-- Host: localhost
-- Generation Time: Dec 23, 2020 at 02:01 PM
...
--
ALTER TABLE `dallas`
  MODIFY `dallasID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `devicenames`
--
ALTER TABLE `devicenames`
  MODIFY `deviceNameID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `dhtsensor`
--
ALTER TABLE `dhtsensor`
  MODIFY `dhtID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `latitude`
  MODIFY `latitudeID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `soil`
  MODIFY `soilID` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `latitude`
  ...
  ADD CONSTRAINT `latitude_ibfk_2` FOREIGN KEY (`groupNameID`) REFERENCES `groupname` (`groupNameID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `latitude_ibfk_3` FOREIGN KEY (`roomID`) REFERENCES `room` (`roomID`) ON DELETE CASCADE ON UPDATE CASCADE,
