...
import { BoolCardCurrentSensorDataInterface } from './CurrentReadingDataDisplayInterface';
import { capitalizeFirstLetter } from '../../../../../Common/StringFormatter';

export function BoolCurrentReadingSensorDataOutput(props: { sensorData: BoolCardCurrentSensorDataInterface[]|undefined; }) {
    ...
    if (sensorData !== undefined && sensorData.length > 0) {
        return (
            <React.Fragment>
                {
                    sensorData.map((data: BoolCardCurrentSensorDataInterface, index: number) => {
                        return (
