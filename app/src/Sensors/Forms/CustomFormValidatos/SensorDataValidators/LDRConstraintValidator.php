...
class LDRConstraintValidator extends ConstraintValidator
{
    /**
    ...
    {
        if (!$constraint instanceof LDRConstraint) {
        ...
        if (is_numeric($value) && $value > LDR::HIGH_READING) {
        ...
        if (is_numeric($value) && $value < LDR::LOW_READING) {
