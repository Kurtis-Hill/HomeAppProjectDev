...
namespace App\Command\Sensor\Elasticsearch\IndicesCreation;
...
#[AsCommand(
    name: 'app:elastic-create-const-record-indices',
    description: 'Creates the indices for the constant record types in ElasticSearch.',
    aliases: ['app:elastic-create-const-record-indices'],
    hidden: false
)]
class ElasticCreateConstRecordIndicesCommand extends Command
{
    ...
    {
        $this->setDescription('Creates the indices for the constant record types in ElasticSearch');
