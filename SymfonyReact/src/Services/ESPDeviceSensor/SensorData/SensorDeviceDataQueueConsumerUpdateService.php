...
class SensorDeviceDataQueueConsumerUpdateService extends AbstractSensorUpdateService
{
    /**
     ...
     */
        ...
        {
            try {
                return match ($sensorData['sensorType']) {
     ...
     * @param Devices $device
     */
    #[NoReturn] private function handleDallasUpdateRequest(array $sensorData, Devices $device): bool
    {
