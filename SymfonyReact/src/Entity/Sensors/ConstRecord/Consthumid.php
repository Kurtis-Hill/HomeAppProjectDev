 ...
 * Consthumid
 *
 * @ORM\Table(name="consthumid", indexes={@ORM\Index(name="GroupName", columns={"groupNameID"}), @ORM\Index(name="Room", columns={"roomID"}), @ORM\Index(name="SensorName", columns={"sensorNameID"})})
 * @ORM\Entity
 */
class Consthumid
{
