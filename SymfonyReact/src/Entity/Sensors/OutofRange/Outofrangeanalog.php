 ...
 * Outofrangeanalog
 *
 * @ORM\Table(name="outofrangeanalog", indexes={@ORM\Index(name="groupOne", columns={"groupNameID"}), @ORM\Index(name="roomOne", columns={"roomID"}), @ORM\Index(name="sensorOne", columns={"sensorNameID"})})
 * @ORM\Entity
 */
